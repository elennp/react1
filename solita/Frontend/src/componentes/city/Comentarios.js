...
function Comments(props) {
    ...
    const submitComment = async (event) => {
        ...
        await axios.post("https://mytinerayelenn.herokuapp.com/api/comments", { dataComents })
            .then(response => 
    ...
    useEffect(() => {
        ...
        axios.get(`https://mytinerayelenn.herokuapp.com/api/comments/${id} `)
            .then(response => {
                setComment(response.data.response.comentario)
    ...
    const borrarComentario = async (id) => {
       await axios.delete(`https://mytinerayelenn.herokuapp.com/api/comments/${id} `)
            .then(response => {
                console.log(response)
                swal({
                    title: response.data.message,
