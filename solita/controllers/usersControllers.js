...
async function sendEmail(email,uniqueText){
    ...
    const mailOptions={
        ...
        html:`Presionar <a href=https://mytinerayelenn.herokuapp.com/api/verify/${uniqueText}>Aqui</a>Para validar tu email`
    }
...
const usersControllers = {
    verifyEmail: async (req,res)=>{
      ...
      if (user) {
          ...
          await user.save()
          res.redirect("https://mytinerayelenn.herokuapp.com/form")
